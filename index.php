...
<div class="container" style="padding-top: 30px; ">
    ...
    <div class="jumbotron" style="box-shadow: 2px 2px 6px #777; border-radius: 0px;">
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <p class="lead">Estamos no endereço e redes sociais.</p>
                <p><img src="assets/images/gmap.png" alt="" height="25">&nbsp Quadra 000 Norte, NS 00, CEP: 77000-000, Palmas - Tocantins</p>
    ...
    <div class="form-inline">&nbsp&nbsp&nbsp&nbsp
        ...
        <img class="card-img-top" src="http://localhost/javalato/assets/images/lavagem-bancos.png">
            <div class="card-body">
                <p class="card-text">Higienização de bancos e estofados. Agende já seu horário!</p>
            </div>
        </div>
    </div>
</div>
